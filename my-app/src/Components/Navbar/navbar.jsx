...
export function NavbarComponent() {
  ...
  const AuthButtons = ({ isMobile = false }) => {
    if (user) {
      return (
        <Button size="sm" onClick={signout} className={isMobile ? "cursor-pointer italic bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-semibold tracking-wide shadow-lg hover:from-teal-700 hover:to-cyan-700 hover:scale-105 transition-transform duration-300    " : "hidden sm:inline-block bg-gradient-to-r italic cursor-pointer from-teal-600 to-cyan-600 text-white font-semibold tracking-wide shadow-lg hover:from-teal-700 hover:to-cyan-700 hover:scale-105 transition-transform duration-300 "}>
          Sign Out
        </Button>
      );
    }
    ...
    return (
      <div className={`flex gap-2 ${isMobile ? "flex-col " : "hidden  sm:flex not-only:"}`}>
        <Button
          className="bg-gradient-to-r from-teal-600 to-cyan-600 cursor-pointer text-white font-semibold italic tracking-wide shadow-lg hover:from-teal-700 hover:to-cyan-700 hover:scale-105 transition-transform duration-300 "
      ...
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:order-2">
          ...
          <button
            ...
            className="md:hidden p-2 cursor-pointer text-gray-700 hover:bg-gray-100 rounded focus:outline-none focus:ring-2 focus:ring-cyan-500"
          >
