  ...
  import pic3 from '/images/third-hero.webp';
...
const navigate = useNavigate();
  ...
  <div className="w-full h-auto md:h-[600px] flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-16 py-10 bg-gradient-to-br from-[#fdfcfb] via-[#f1f1f1] to-[#e4e4e4] border-b border-gray-200">
    ...
    {/* Text Section */}
    <div
      className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start text-center md:text-left space-y-4 p-10"
      data-aos="fade-right"
    ...
    {/* Image Section */}
    <div
      className="w-full md:w-auto flex justify-center items-center mb-8 md:mb-0 p-10"
      data-aos="zoom-in"
      data-aos-delay="300"
      data-aos-duration="1000"
    >
      <div className="relative w-full h-auto sm:h-auto md:h-auto lg:h-[400px] max-w-sm md:max-w-md lg:max-w-lg bg-white rounded-2xl overflow-hidden shadow-md">
        <img
          src={pic1}
          alt="Essential Collection"
          className="w-atox
          h-full object-cover rounded-2xl transition-transform duration-500"
        />

        {/* Optional blur effect layer */}
        <div className="absolute inset-0 bg-gradient-to-br to-transparent blur-2xl opacity-30 pointer-events-none rounded-2xl"></div>
      </div>
    </div>
  </div>
  ...
  <div className="w-full min-h-[500px] md:min-h-[600px] flex flex-col-reverse md:flex-row items-center justify-center bg-gradient-to-bl from-gray-100 to-white px-4 py-10 md:py-16">
    ...
    >
      ...
      <button onClick={HandleButton} className="mt-4 px-6 py-2 border-2 bg-gradient-to-r from-cyan-500 to-teal-700  hover:from-cyan-700 hover:to-teal-500 text-white font-semibold transition-all duration-300 rounded-lg hover:scale-105 hover:shadow-lg cursor-pointer">
        Shop Now
      </button>
    </div>
    </div>
    ...
    >
      <img
        src={pic2}
        alt="Fashion"
        className="w-[250px] sm:w-[300px] md:w-[350px] lg:w-[400px] h-auto object-contain transition-transform duration-500 hover:scale-105"
      />
    </div>
  </div>
  ...
  <div className="w-full min-h-[500px] md:min-h-[600px] flex flex-col-reverse md:flex-row-reverse items-center justify-center bg-gradient-to-br from-gray-100 to-white px-4 py-10 md:py-16">
    ...
    >
      ...
      <button onClick={HandleButton} className="mt-2 px-6 py-2 border-2 bg-gradient-to-r from-cyan-500 to-teal-700  hover:from-cyan-700 hover:to-teal-500 text-white font-semibold transition-all duration-300 rounded-lg hover:scale-105 hover:shadow-lg cursor-pointer">
        Shop Now
      </button>
    </div>
    ...
    >
      ...
      />
        ...
        onClick={HandleButton}
         className="h-15 px-6 mt-6 w-50 border-2 rounded-xl font-bold bg-cyan-600 text-white  border-black hover:bg-cyan-900 cursor-pointer">
          ALL PRODUCTS
        </button>
      </div>
